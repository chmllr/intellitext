...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12403 = (0);while(true){
var m_12404 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12404 == null))
{} else
{m_12404.call(null);
if((count_12403 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12405 = (count_12403 + (1));
count_12403 = G__12405;
continue;
}
} else
{}
