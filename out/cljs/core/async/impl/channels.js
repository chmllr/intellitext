...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12409 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12409 = (function (val,box,meta12410){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12409.cljs$lang$type = true;
cljs.core.async.impl.channels.t12409.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12409";
cljs.core.async.impl.channels.t12409.cljs$lang$ctorPrWriter = (function (this__4120__auto__,writer__4121__auto__,opt__4122__auto__){return cljs.core._write.call(null,writer__4121__auto__,"cljs.core.async.impl.channels/t12409");
});
cljs.core.async.impl.channels.t12409.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12409.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12411){var self__ = this;
var _12411__$1 = this;return self__.meta12410;
});
cljs.core.async.impl.channels.t12409.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12411,meta12410__$1){var self__ = this;
var _12411__$1 = this;return (new cljs.core.async.impl.channels.t12409(self__.val,self__.box,meta12410__$1));
});
cljs.core.async.impl.channels.__GT_t12409 = (function __GT_t12409(val__$1,box__$1,meta12410){return (new cljs.core.async.impl.channels.t12409(val__$1,box__$1,meta12410));
});
}
return (new cljs.core.async.impl.channels.t12409(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_12412 = self__.takes.pop();if((taker_12412 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12412))
{var take_cb_12413 = cljs.core.async.impl.protocols.commit.call(null,taker_12412);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12413,taker_12412,this$__$1){
return (function (){return take_cb_12413.call(null,null);
});})(take_cb_12413,taker_12412,this$__$1))
);
} else
{}
{
...
var putter_12414 = self__.puts.pop();if(!((putter_12414 == null)))
{var put_handler_12415 = putter_12414.handler;var val_12416 = putter_12414.val;if(cljs.core.async.impl.protocols.active_QMARK_.call(null,put_handler_12415))
{var put_cb_12417 = cljs.core.async.impl.protocols.commit.call(null,put_handler_12415);var __12418__$1 = cljs.core.async.impl.protocols.commit.call(null,handler);cljs.core.async.impl.dispatch.run.call(null,((function (put_cb_12417,__12418__$1,put_handler_12415,val_12416,putter_12414,_,retval,this$__$1){
return (function (){return put_cb_12417.call(null,true);
});})(put_cb_12417,__12418__$1,put_handler_12415,val_12416,putter_12414,_,retval,this$__$1))
);
cljs.core.async.impl.protocols.add_BANG_.call(null,self__.buf,val_12416);
} else
{{
continue;
}
