...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + (1))));var i_12310 = (0);while(true){
if((i_12310 < arr.length))
{(arr[i_12310] = null);
{
var G__12311 = (i_12310 + (1));
i_12310 = G__12311;
continue;
}
} else
...
{var i_12317 = (self__.level + (1));while(true){
if((i_12317 <= (new_level + (1))))
{(update[i_12317] = self__.header);
{
var G__12318 = (i_12317 + (1));
i_12317 = G__12318;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[(0)]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12319 = (0);while(true){
if((i_12319 <= self__.level))
{var links_12320 = (update[i_12319]).forward;if(((links_12320[i_12319]) === x__$1))
{(links_12320[i_12319] = (x__$1.forward[i_12319]));
{
